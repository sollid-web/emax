      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {user?.is_admin && (
            <Link
              href="/admin"
              className="flex items-center gap-2 px-3 py-2 bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-400 rounded-lg transition text-sm font-medium"
            >
              <ShieldCheck size={16} />
              Admin
            </Link>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown Menu */}
            {profileOpen && (
              <div className="absolute right-0 top-12 w-72 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl z-50 overflow-hidden">
                ...
                <div className="p-4 border-b border-gray-800">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {user?.is_admin && (
                        <span className="text-xs text-yellow-400 font-medium flex items-center gap-1 mt-0.5">
                ...
                <div className="p-2">
                  <Link
                    ...
                    className="flex items-center gap-3 px-3 py-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition text-sm"
                  >
                    <FileCheck size={16} />
                    KYC Verification
                  </Link>
                  ...
                  {user?.is_admin && (
                    <Link
                      href="/admin"
                      onClick={() => setProfileOpen(false)}
                      className="flex items-center gap-3 px-3 py-2 text-yellow-400 hover:text-white hover:bg-gray-800 rounded-lg transition text-sm"
                    >
                      <ShieldCheck size={16} />
                      Admin Dashboard
                    </Link>
                ...
                <div className="p-2 border-t border-gray-800">
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2 text-red-400 hover:text-white hover:bg-red-900/30 rounded-lg transition text-sm"
                  >
                    <LogOut size={16} />
                    Sign Out
                  </button>
