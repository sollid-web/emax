    ...
    <>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mb-3">Crypto Investment Platform, Automated Crypto Trading, and Daily ROI Details</h2>
          <p className="text-xl text-gray-600">Get answers to common questions about algorithmic trading, fees, security, and compliance on Emax Protocol.</p>
        </div>
