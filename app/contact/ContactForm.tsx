...
export default function ContactForm() {
  ...
  const jsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "Emax Protocol",
    description: "Crypto investment platform with automated crypto trading and trading plans",
    address: {
      "@type": "PostalAddress",
      streetAddress: "1735 Bingamon Branch Road",
      addressLocality: "New York",
      addressCountry: "US",
    },
    telephone: "+11-22-3333-4444",
      ...
      <div className="pt-16 min-h-screen">
        ...
        <section className="bg-gradient-to-br from-blue-600 to-purple-700 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <h2 className="text-2xl font-semibold text-blue-100 mb-3">Help with Your Crypto Investment Platform Journey</h2>
